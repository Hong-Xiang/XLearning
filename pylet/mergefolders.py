...
class Merger(object):    
    ...
    def argument_parse(self, argv):
        ...
        parser.add_argument('--targe', '-t', dest='target', default='.')
        parser.add_argument('--noaction', '-n', action='store_true', default=False)
        parser.add_argument('--recurrent', '-r', action='store_true', default=False)
