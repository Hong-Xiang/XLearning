...
def plot_event(evt_map, inc_pos=None, sci_poss=None):
    ...
    inci_point = Circle(
        (x, y), radius=((-inc_pos[2]+12.5)/5) / 5, linewidth=1, edgecolor='r', facecolor='none')
    ax.add_patch(inci_point)
    inci_circle = Circle((x, y), radius=0.05, linewidth=1,
