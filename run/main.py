...
from xlearn.utils.general import with_config, empty_list, enter_debug, ProgressTimer, print_pretty_args
...
class DLRun:
    ...
    def dataset(self, dataset_name):
        return getattr(xlearn.datasets, dataset_name)

    def net(self, net_name):
        return getattr(xlearn.nets, net_name)
    ...
    def train_sr_d(self,
                   ...
                   phase=0,
                   **kwargs):
        print_pretty_args(getfullargspec(train_sr_d.__warpped))
        # if is_debug:
        #     enter_debug()
    ...
    #     click.echo("=" * 30)
    #     click.echo("Train with setttings")
    #     click.echo(settings)
    #     click.echo("=" * 30)
    #     if is_debug:
    #         enter_debug()
    ...
    #         if net_name == 'CAAE1D':
    #             if is_p2:
    #                 click.echo('Train CAAE1D in P2')
    #                 net.load()
    #                 net.fit_p2(dataset, phase=0)
    #                 net.save()
    #             else:
    #                 click.echo('Train CAAE1D in P1')
    ...
    #                   settings=None,
    #                   **kwargs):
    #     click.echo('Genererate routine is called.')
    #     net_name = settings.get('net_name', net_name)
    #     dataset_name = settings.get('dataset_name', dataset_name)
    #     is_debug = settings.get('is_debug', is_debug)
    #     config_files = settings.get('config_files', config_files)
    ...
    #                filenames=None,
    #                **kwargs):
    #     click.echo("Predict routine is called.")
    #     net_name = settings.get('net_name', net_name)
    #     dataset_name = settings.get('dataset_name', dataset_name)
    #     is_debug = settings.get('is_debug', is_debug)
    #     config_files = settings.get('config_files', config_files)
    ...
    #         click.echo('res_sr: {0:10f}, res_it: {1:10f}'.format(
    #             res_sr_v, res_it_v))
